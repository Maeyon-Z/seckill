...
public interface SeckillActivityCacheService extends SeckillCacheService {
     ...
     * 增加二级缓存的根据状态获取活动列表
     */
    SeckillBusinessCache<SeckillActivity> getCachedActivity(Long id, Long version);

    /**
     * 更新缓存数据
     */
    SeckillBusinessCache<SeckillActivity> tryUpdateSeckillActivityCacheByLock(Long id, boolean doubleCheck);
}
